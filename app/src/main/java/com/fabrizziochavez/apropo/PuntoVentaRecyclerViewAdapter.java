 ...
 */
public class PuntoVentaRecyclerViewAdapter extends RecyclerView.Adapter<PuntoVentaRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_puntoventa, parent, false);
